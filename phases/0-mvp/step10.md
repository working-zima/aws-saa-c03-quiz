...
`docs/source/concepts-raw.md`의 **19~35페이지**를 읽고, 아래  주제를
...
|---|---|---|---|
| `rds-storage-features` | RDS 스토리지 유형과 기능 | 3 | [19, 20] |
| `aurora-dynamodb-cache` | Aurora·DynamoDB·ElastiCache | 3 | [21, 21] |
| `compute-delivery` | EC2·ELB·Global Accelerator·CloudFront | 3 | [22, 24] |
| `serverless-containers` | ECS·Lambda·Step Functions·API Gateway | 3 | [25, 26] |
| `messaging-backup` | SQS·SNS·EventBridge·AWS Backup | 3 | [27, 29] |
| `vpc-networking` | VPC·서브넷·인터넷/NAT 게이트웨이·VPC Endpoint·PrivateLink·피어링 | 3 | [30, 33] |
| `hybrid-connectivity` | Site-to-Site VPN·Direct Connect·Transit Gateway | 3 | [34, 35] |
...
- 주제 16번 이후(Route 53, 보안, 비용 등)를 넣지 마라. 이유: step 11의 범위다.
