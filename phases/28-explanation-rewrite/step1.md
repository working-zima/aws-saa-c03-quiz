# Step 1: rewrite-core-storage-classes — 해설 25개 재작성
...
|---|---|---|---|
| `aws-core-services` | AWS 핵심 서비스·리전·가용 영역·온프레미스 | 18 | 16 |
| `s3-storage-classes` | S3 스토리지 클래스 유형 | 17 | 9 |

**담당 문항 25개. 현재 해설 평균 123자, 최소 64자다.**

| 문항 | 현재 해설 길이 | 근거 개념 | 근거 |
|---|---|---|---|
| `q001` | 150 | `aws-core-services.ec2` | 개념 본문 |
| `q002` | 152 | `aws-core-services.rds` | 개념 본문 |
| `q003` | 108 | `aws-core-services.s3` | 개념 본문 |
| `q004` | 151 | `aws-core-services.route-53` | 개념 본문 |
| `q005` | 191 | `aws-core-services.dns` | 개념 본문 |
| `q006` | 130 | `aws-core-services.elb` | 개념 본문 |
| `q007` | 105 | `aws-core-services.cloudfront` | 개념 본문 |
| `q008` | 165 | `aws-core-services.lambda` | 개념 본문 |
| `q009` | 64 | `aws-core-services.region` | 개념 본문 |
| `q010` | 65 | `aws-core-services.availability` | 개념 본문 |
| `q011` | 87 | `aws-core-services.availability-zone` | 개념 본문 |
| `q012` | 89 | `aws-core-services.multi-az` | 개념 본문 |
| `q013` | 100 | `aws-core-services.single-az` | 개념 본문 |
| `q014` | 69 | `aws-core-services.on-premise` | 개념 본문 |
| `q015` | 83 | `aws-core-services.migration` | 개념 본문 |
| `q016` | 136 | `s3-storage-classes.intelligent-tiering` | 개념 본문 |
| `q017` | 104 | `s3-storage-classes.standard` | 개념 본문 |
| `q018` | 101 | `s3-storage-classes.standard-ia` | 개념 본문 |
| `q019` | 121 | `s3-storage-classes.one-zone-ia` | 개념 본문 |
| `q020` | 141 | `s3-storage-classes.glacier-instant-retrieval` | 개념 본문 |
| `q021` | 192 | `s3-storage-classes.glacier-flexible-retrieval` | 개념 본문 |
| `q022` | 168 | `s3-storage-classes.glacier-deep-archive` | 개념 본문 |
| `q023` | 78 | `s3-storage-classes.glacier-or-standard-ia` | 개념 본문 |
| `q024` | 162 | `s3-storage-classes.retrieval-time` | 개념 본문 |
| `q170` | 155 | `aws-core-services.exam-heuristics` | `exam-gaps.md`의 `exam-heuristics` |

이 중 **1문항**은 근거 개념이 `docs/source/exam-gaps.md`에도 항목으로 있다(위 표의 "근거" 열). 그 개념은 개념 본문과 exam-gaps 항목 **양쪽**을 읽어라 — exam-gaps 항목에는 `[섹션 #문항 pP]` 인용이 붙어 있어 개념 본문이 줄인 사실(수치 한계·전제 조건 등)이 남아 있을 수 있다.

담당 문항의 현재 미달 상태를 다시 재려면:

```bash
node scripts/explanation-audit.mjs aws-core-services s3-storage-classes
```

## 작업

담당 문항 25개의 `explanation`을 **그 개념을 가르치는 글**로 다시 쓴다.
...
npm test                                               # 전부 통과
node scripts/explanation-audit.mjs aws-core-services s3-storage-classes  # exit 0 — 담당 문항 전부 187자 이상
```
...
1. 위 AC 커맨드를 실행한다.
2. `node scripts/explanation-audit.mjs aws-core-services s3-storage-classes`가 내는 "오답 언급" 열을 눈으로 확인한다.
