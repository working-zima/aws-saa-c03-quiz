# Step 8: rewrite-vpc-route53 — 해설 22개 재작성
...
|---|---|---|---|
| `vpc-networking` | VPC·서브넷·인터넷/NAT 게이트웨이·VPC Endpoint·PrivateLink·피어링 | 20 | 14 |
| `route53` | Route 53 | 13 | 8 |

**담당 문항 22개. 현재 해설 평균 125자, 최소 80자다.**

| 문항 | 현재 해설 길이 | 근거 개념 | 근거 |
|---|---|---|---|
| `q100` | 109 | `vpc-networking.vpc-subnet` | 개념 본문 |
| `q101` | 132 | `vpc-networking.internet-gateway` | 개념 본문 |
| `q102` | 125 | `vpc-networking.nat-gateway` | 개념 본문 |
| `q103` | 103 | `vpc-networking.nat-gateway` | 개념 본문 |
| `q104` | 142 | `vpc-networking.vpc-endpoint` | 개념 본문 |
| `q105` | 141 | `vpc-networking.vpc-endpoint` | 개념 본문 |
| `q106` | 119 | `vpc-networking.privatelink` | 개념 본문 |
| `q107` | 101 | `vpc-networking.vpc-peering` | 개념 본문 |
| `q108` | 162 | `vpc-networking.comparison` | 개념 본문 |
| `q117` | 103 | `route53.route53` | 개념 본문 |
| `q118` | 110 | `route53.routing-policies` | 개념 본문 |
| `q119` | 80 | `route53.routing-policies` | 개념 본문 |
| `q120` | 113 | `route53.routing-policies` | 개념 본문 |
| `q121` | 120 | `route53.resolver` | 개념 본문 |
| `q122` | 115 | `route53.resolver` | 개념 본문 |
| `q209` | 119 | `vpc-networking.endpoint-pricing` | `exam-gaps.md`의 `endpoint-pricing` |
| `q210` | 118 | `vpc-networking.egress-only-igw` | `exam-gaps.md`의 `egress-only-igw` |
| `q211` | 212 | `vpc-networking.nat-instance` | `exam-gaps.md`의 `nat-instance` |
| `q212` | 123 | `vpc-networking.vpc-peering-scaling-limit` | `exam-gaps.md`의 `vpc-peering-scaling-limit` |
| `q213` | 154 | `vpc-networking.s3-is-regional` | `exam-gaps.md`의 `s3-is-regional` |
| `q220` | 164 | `route53.private-hosted-zone` | `exam-gaps.md`의 `private-hosted-zone` |
| `q221` | 82 | `route53.multivalue-answer-details` | `exam-gaps.md`의 `multivalue-answer-details` |
...
```bash
node scripts/explanation-audit.mjs vpc-networking route53
```

## 작업

담당 문항 22개의 `explanation`을 **그 개념을 가르치는 글**로 다시 쓴다.
...
npm test                                               # 전부 통과
node scripts/explanation-audit.mjs vpc-networking route53  # exit 0 — 담당 문항 전부 187자 이상
```
...
1. 위 AC 커맨드를 실행한다.
2. `node scripts/explanation-audit.mjs vpc-networking route53`가 내는 "오답 언급" 열을 눈으로 확인한다.
