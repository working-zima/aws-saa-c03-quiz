# Step 4: rewrite-rds-aurora-dynamodb — 해설 21개 재작성
...
|---|---|---|---|
| `rds-storage-features` | RDS 스토리지 유형과 기능 | 21 | 12 |
| `aurora` | Aurora·Aurora Serverless·글로벌 데이터베이스 | 18 | 5 |
| `dynamodb` | DynamoDB | 18 | 4 |

**담당 문항 21개. 현재 해설 평균 117자, 최소 100자다.**

| 문항 | 현재 해설 길이 | 근거 개념 | 근거 |
|---|---|---|---|
| `q058` | 120 | `rds-storage-features.rds` | 개념 본문 |
| `q059` | 117 | `rds-storage-features.storage-types` | 개념 본문 |
| `q060` | 140 | `rds-storage-features.features` | 개념 본문 |
| `q061` | 121 | `rds-storage-features.features` | 개념 본문 |
| `q062` | 107 | `rds-storage-features.features` | 개념 본문 |
| `q063` | 102 | `rds-storage-features.features` | 개념 본문 |
| `q064` | 133 | `rds-storage-features.features` | 개념 본문 |
| `q065` | 127 | `rds-storage-features.features` | 개념 본문 |
| `q066` | 107 | `aurora.aurora` | 개념 본문 |
| `q067` | 108 | `aurora.aurora` | 개념 본문 |
| `q068` | 101 | `aurora.aurora` | 개념 본문 |
| `q069` | 161 | `dynamodb.dynamodb` | 개념 본문 |
| `q070` | 102 | `dynamodb.dynamodb` | 개념 본문 |
| `q071` | 102 | `dynamodb.dynamodb` | 개념 본문 |
| `q179` | 117 | `rds-storage-features.storage-type-names` | `exam-gaps.md`의 `storage-type-names` |
| `q180` | 107 | `rds-storage-features.multi-az-standby-limits` | `exam-gaps.md`의 `multi-az-standby-limits` |
| `q181` | 100 | `rds-storage-features.automated-backup-retention` | `exam-gaps.md`의 `automated-backup-retention` |
| `q182` | 127 | `rds-storage-features.connection-issue-heuristic` | `exam-gaps.md`의 `connection-issue-heuristic` |
| `q183` | 111 | `aurora.aurora-serverless-v2` | `exam-gaps.md`의 `aurora-serverless-v2` |
| `q184` | 142 | `aurora.aurora-reader-endpoint` | `exam-gaps.md`의 `aurora-reader-endpoint` |
| `q186` | 102 | `dynamodb.dynamodb-pitr` | `exam-gaps.md`의 `dynamodb-pitr` |
...
```bash
node scripts/explanation-audit.mjs rds-storage-features aurora dynamodb
```
...
npm test                                               # 전부 통과
node scripts/explanation-audit.mjs rds-storage-features aurora dynamodb  # exit 0 — 담당 문항 전부 187자 이상
```
...
1. 위 AC 커맨드를 실행한다.
2. `node scripts/explanation-audit.mjs rds-storage-features aurora dynamodb`가 내는 "오답 언급" 열을 눈으로 확인한다.
