# Step 11: rewrite-secrets-iam — 해설 18개 재작성
...
|---|---|---|---|
| `secrets-encryption` | Secrets Manager·Parameter Store·KMS·ACM·CloudHSM | 20 | 12 |
| `iam-permissions` | IAM 사용자·그룹·역할·정책·권한 경계·Access Analyzer | 18 | 6 |

**담당 문항 18개. 현재 해설 평균 123자, 최소 59자다.**

| 문항 | 현재 해설 길이 | 근거 개념 | 근거 |
|---|---|---|---|
| `q138` | 89 | `secrets-encryption.secrets-manager` | 개념 본문 |
| `q139` | 102 | `secrets-encryption.parameter-store` | 개념 본문 |
| `q140` | 88 | `secrets-encryption.secrets-manager-vs-parameter-store` | 개념 본문 |
| `q141` | 137 | `secrets-encryption.kms` | 개념 본문 |
| `q142` | 101 | `secrets-encryption.kms` | 개념 본문 |
| `q143` | 196 | `secrets-encryption.acm` | 개념 본문 |
| `q144` | 59 | `secrets-encryption.secrets-manager-vs-parameter-store` | 개념 본문 |
| `q145` | 131 | `secrets-encryption.kms` | 개념 본문 |
| `q155` | 101 | `iam-permissions.iam` | 개념 본문 |
| `q156` | 134 | `iam-permissions.iam` | 개념 본문 |
| `q157` | 140 | `iam-permissions.iam` | 개념 본문 |
| `q227` | 154 | `secrets-encryption.acm-cloudfront-region` | `exam-gaps.md`의 `acm-cloudfront-region` |
| `q228` | 105 | `secrets-encryption.lambda-env-var-kms` | `exam-gaps.md`의 `lambda-env-var-kms` |
| `q229` | 133 | `secrets-encryption.cloudhsm` | `exam-gaps.md`의 `cloudhsm` |
| `q230` | 167 | `secrets-encryption.rotation-heuristic` | `exam-gaps.md`의 `rotation-heuristic` |
| `q237` | 85 | `iam-permissions.least-privilege` | `exam-gaps.md`의 `least-privilege` |
| `q238` | 163 | `iam-permissions.instance-profile` | `exam-gaps.md`의 `instance-profile` |
| `q239` | 136 | `iam-permissions.iam-group-users-only` | `exam-gaps.md`의 `iam-group-users-only` |
...
```bash
node scripts/explanation-audit.mjs secrets-encryption iam-permissions
```
...
npm test                                               # 전부 통과
node scripts/explanation-audit.mjs secrets-encryption iam-permissions  # exit 0 — 담당 문항 전부 187자 이상
```
...
1. 위 AC 커맨드를 실행한다.
2. `node scripts/explanation-audit.mjs secrets-encryption iam-permissions`가 내는 "오답 언급" 열을 눈으로 확인한다.
