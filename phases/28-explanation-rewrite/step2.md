# Step 2: rewrite-s3-lifecycle-encryption — 해설 19개 재작성
...
|---|---|---|---|
| `s3-versioning-lifecycle` | S3 버전 관리·객체 잠금·수명 주기·복제 | 10 | 11 |
| `s3-encryption-batch` | S3 암호화(SSE)·Batch Operations·인벤토리 | 13 | 8 |

**담당 문항 19개. 현재 해설 평균 109자, 최소 60자다.**

| 문항 | 현재 해설 길이 | 근거 개념 | 근거 |
|---|---|---|---|
| `q025` | 88 | `s3-versioning-lifecycle.versioning` | 개념 본문 |
| `q026` | 67 | `s3-versioning-lifecycle.versioning` | 개념 본문 |
| `q027` | 91 | `s3-versioning-lifecycle.object-lock` | 개념 본문 |
| `q028` | 66 | `s3-versioning-lifecycle.object-lock` | 개념 본문 |
| `q029` | 60 | `s3-versioning-lifecycle.object-lock` | 개념 본문 |
| `q030` | 81 | `s3-versioning-lifecycle.object-lock` | 개념 본문 |
| `q031` | 91 | `s3-versioning-lifecycle.lifecycle-policy` | 개념 본문 |
| `q032` | 93 | `s3-versioning-lifecycle.lifecycle-policy` | 개념 본문 |
| `q033` | 67 | `s3-versioning-lifecycle.lifecycle-policy` | 개념 본문 |
| `q034` | 309 | `s3-encryption-batch.sse` | 개념 본문 |
| `q035` | 114 | `s3-encryption-batch.sse-types` | 개념 본문 |
| `q036` | 114 | `s3-encryption-batch.sse-types` | 개념 본문 |
| `q037` | 104 | `s3-encryption-batch.sse-types` | 개념 본문 |
| `q038` | 106 | `s3-encryption-batch.sse-types` | 개념 본문 |
| `q039` | 105 | `s3-encryption-batch.batch-operations` | 개념 본문 |
| `q171` | 125 | `s3-versioning-lifecycle.object-lock-prerequisites` | `exam-gaps.md`의 `object-lock-prerequisites` |
| `q172` | 130 | `s3-versioning-lifecycle.event-notification` | `exam-gaps.md`의 `event-notification` |
| `q173` | 101 | `s3-encryption-batch.envelope-encryption` | `exam-gaps.md`의 `envelope-encryption` |
| `q174` | 156 | `s3-encryption-batch.sse-kms-cost` | `exam-gaps.md`의 `sse-kms-cost` |
...
```bash
node scripts/explanation-audit.mjs s3-versioning-lifecycle s3-encryption-batch
```
...
npm test                                               # 전부 통과
node scripts/explanation-audit.mjs s3-versioning-lifecycle s3-encryption-batch  # exit 0 — 담당 문항 전부 187자 이상
```
...
1. 위 AC 커맨드를 실행한다.
2. `node scripts/explanation-audit.mjs s3-versioning-lifecycle s3-encryption-batch`가 내는 "오답 언급" 열을 눈으로 확인한다.
