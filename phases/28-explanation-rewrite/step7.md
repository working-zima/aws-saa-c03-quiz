# Step 7: rewrite-messaging-analytics — 해설 19개 재작성
...
|---|---|---|---|
| `sqs-sns-eventbridge` | SQS·SNS·EventBridge·Amazon MQ·SES | 33 | 12 |
| `cloudwatch-xray` | CloudWatch·X-Ray·Performance Insights·Managed Grafana | 11 | 2 |
| `emr-glue-athena` | EMR·Spark·Glue·Athena·Lake Formation | 20 | 5 |

**담당 문항 19개. 현재 해설 평균 129자, 최소 89자다.**

| 문항 | 현재 해설 길이 | 근거 개념 | 근거 |
|---|---|---|---|
| `q091` | 120 | `sqs-sns-eventbridge.sqs` | 개념 본문 |
| `q092` | 106 | `sqs-sns-eventbridge.sqs` | 개념 본문 |
| `q093` | 89 | `sqs-sns-eventbridge.sqs` | 개념 본문 |
| `q094` | 138 | `sqs-sns-eventbridge.sqs` | 개념 본문 |
| `q095` | 131 | `sqs-sns-eventbridge.sns` | 개념 본문 |
| `q096` | 127 | `sqs-sns-eventbridge.eventbridge` | 개념 본문 |
| `q097` | 159 | `sqs-sns-eventbridge.eventbridge` | 개념 본문 |
| `q099` | 104 | `sqs-sns-eventbridge.sqs` | 개념 본문 |
| `q123` | 151 | `emr-glue-athena.emr` | 개념 본문 |
| `q124` | 112 | `emr-glue-athena.spark` | 개념 본문 |
| `q125` | 148 | `emr-glue-athena.athena` | 개념 본문 |
| `q126` | 101 | `cloudwatch-xray.cloudwatch` | 개념 본문 |
| `q127` | 107 | `emr-glue-athena.glue` | 개념 본문 |
| `q203` | 150 | `sqs-sns-eventbridge.sqs-details` | `exam-gaps.md`의 `sqs-details` |
| `q204` | 107 | `sqs-sns-eventbridge.sqs-queue-depth-scaling` | `exam-gaps.md`의 `sqs-queue-depth-scaling` |
| `q205` | 132 | `sqs-sns-eventbridge.eventbridge-scheduler` | `exam-gaps.md`의 `eventbridge-scheduler` |
| `q207` | 148 | `sqs-sns-eventbridge.ses` | `exam-gaps.md`의 `ses` |
| `q222` | 182 | `emr-glue-athena.glue-crawler` | `exam-gaps.md`의 `glue-crawler` |
| `q223` | 148 | `cloudwatch-xray.log-analysis-options` | `exam-gaps.md`의 `log-analysis-options` |

이 중 **6문항**은 근거 개념이 `docs/source/exam-gaps.md`에도 항목으로 있다(위 표의 "근거" 열). 그 개념은 개념 본문과 exam-gaps 항목 **양쪽**을 읽어라 — exam-gaps 항목에는 `[섹션 #문항 pP]` 인용이 붙어 있어 개념 본문이 줄인 사실(수치 한계·전제 조건 등)이 남아 있을 수 있다.

담당 문항의 현재 미달 상태를 다시 재려면:

```bash
node scripts/explanation-audit.mjs sqs-sns-eventbridge cloudwatch-xray emr-glue-athena
```
...
npm test                                               # 전부 통과
node scripts/explanation-audit.mjs sqs-sns-eventbridge cloudwatch-xray emr-glue-athena  # exit 0 — 담당 문항 전부 187자 이상
```
...
1. 위 AC 커맨드를 실행한다.
2. `node scripts/explanation-audit.mjs sqs-sns-eventbridge cloudwatch-xray emr-glue-athena`가 내는 "오답 언급" 열을 눈으로 확인한다.
