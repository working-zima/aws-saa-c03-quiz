...
|---|---|---|
| `rds-storage-features` | `storage-type-names`, `multi-az-standby-limits`, `automated-backup-retention`, `connection-issue-heuristic` | 4 |
| `aurora-dynamodb-cache` | `aurora-serverless-v2`, `aurora-reader-endpoint`, `documentdb`, `dynamodb-pitr`, `dax-dynamodb-only` | 5 |
