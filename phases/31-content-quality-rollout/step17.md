# Step 17: api-gateway-step-functions
...
|---|---|---|---|---|---|---|---|---|
| `api-gateway-step-functions` | 20 | 25 | 8 | 12 (개념 5/문항 7) | — | — | — | — |
...
`api-gateway-step-functions` — 개념 20개. **①이 걸린 것은 굵게 표시했다.**
...
`api-gateway-step-functions` — 25개: `q088` `q089` `q090` `q200` `q206` `q529` `q530` `q531` `q532` `q533` `q534` `q535` `q536` `q537` `q538` `q539` `q540` `q541` `q542` `q543` `q544` `q545` `q546` `q547` `q548`
...
node scripts/content-audit.mjs api-gateway-step-functions# ①②④ 0건
```
