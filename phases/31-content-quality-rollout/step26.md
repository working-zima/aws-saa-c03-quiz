...
|---|---|---|---|---|---|---|---|---|
| `kinesis-streaming` | 16 | 17 | 5 | 5 (개념 2/문항 3) | — | — | — | — |
...
`kinesis-streaming` — 개념 16개. **①이 걸린 것은 굵게 표시했다.**
...
`kinesis-streaming` — 17개: `q128` `q202` `q633` `q634` `q635` `q636` `q637` `q638` `q639` `q640` `q641` `q642` `q643` `q644` `q645` `q646` `q647`
...
node scripts/content-audit.mjs kinesis-streaming# ①②④ 0건
```
