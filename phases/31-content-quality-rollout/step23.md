...
|---|---|---|---|---|---|---|---|---|
| `hybrid-connectivity` | 19 | 24 | 5 | 4 (개념 1/문항 3) | — | — | — | — |
...
`hybrid-connectivity` — 개념 19개. **①이 걸린 것은 굵게 표시했다.**
...
`hybrid-connectivity` — 24개: `q109` `q110` `q111` `q112` `q113` `q114` `q115` `q116` `q214` `q215` `q216` `q217` `q218` `q219` `q599` `q600` `q601` `q602` `q603` `q604` `q605` `q606` `q607` `q608`
...
node scripts/content-audit.mjs hybrid-connectivity# ①②④ 0건
```
