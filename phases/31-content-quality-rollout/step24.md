# Step 24: organizations-cloudtrail-config-and-cost-management
...
| 주제 | 개념 | 문항 |
|---|---|---|
| `organizations-cloudtrail-config` | 16 | 18 |
| `cost-management` | 17 | 19 |
...
`organizations-cloudtrail-config` — `q162` `q163` `q242` `q709` `q710` `q711` `q712` `q713` `q714` `q715` `q716` `q717` `q718` `q719` `q720` `q721` `q722` `q723`

`cost-management` — `q164` `q165` `q166` `q167` `q168` `q169` `q243` `q244` `q245` `q246` `q724` `q725` `q726` `q727` `q728` `q729` `q730` `q731` `q732`
...
const T=['organizations-cloudtrail-config','cost-management'];
