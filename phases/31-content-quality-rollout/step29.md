...
|---|---|---|---|---|---|---|---|---|
| `waf-shield` | 15 | 20 | 3 | 0 (개념 0/문항 0) | — | — | — | — |
...
`waf-shield` — 개념 15개. **①이 걸린 것은 굵게 표시했다.**
...
`waf-shield` — 20개: `q146` `q147` `q148` `q149` `q152` `q153` `q154` `q231` `q232` `q233` `q234` `q668` `q669` `q670` `q671` `q672` `q673` `q674` `q675` `q676`
...
node scripts/content-audit.mjs waf-shield# ①②④ 0건
```
