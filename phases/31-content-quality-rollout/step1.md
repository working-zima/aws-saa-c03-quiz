...
|---|---|---|---|---|---|---|---|---|
| `s3-storage-classes` | 17 | 17 | 0 | 2 (개념 1/문항 1) | — | — | — | — |
...
`s3-storage-classes` — 개념 17개. **①이 걸린 것은 굵게 표시했다.**
...
`s3-storage-classes` — 17개: `q016` `q017` `q018` `q019` `q020` `q021` `q022` `q023` `q024` `q319` `q320` `q321` `q322` `q323` `q324` `q325` `q326`
...
node scripts/content-audit.mjs s3-storage-classes# ①②④ 0건
```
