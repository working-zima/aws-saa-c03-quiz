...
|---|---|---|---|---|---|---|---|---|
| `security-groups-nacl` | 9 | 17 | 3 | 1 (개념 1/문항 0) | — | — | — | — |
...
`security-groups-nacl` — 개념 9개. **①이 걸린 것은 굵게 표시했다.**
...
`security-groups-nacl` — 17개: `q129` `q130` `q131` `q132` `q133` `q134` `q135` `q136` `q137` `q224` `q225` `q226` `q594` `q595` `q596` `q597` `q598`
...
node scripts/content-audit.mjs security-groups-nacl# ①②④ 0건
```
