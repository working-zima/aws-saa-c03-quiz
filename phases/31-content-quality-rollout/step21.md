# Step 21: cloudwatch-xray-and-secrets-encryption
...
| 주제 | 개념 | 문항 |
|---|---|---|
| `cloudwatch-xray` | 11 | 11 |
| `secrets-encryption` | 20 | 23 |
...
`cloudwatch-xray` — `q126` `q223` `q648` `q649` `q650` `q651` `q652` `q653` `q654` `q655` `q656`

`secrets-encryption` — `q138` `q139` `q140` `q141` `q142` `q143` `q144` `q145` `q227` `q228` `q229` `q230` `q657` `q658` `q659` `q660` `q661` `q662` `q663` `q664` `q665` `q666` `q667`
...
const T=['cloudwatch-xray','secrets-encryption'];
