# Step 27: redshift-opensearch-quicksight-and-cloudwatch-xray
...
|---|---|---|---|---|---|---|---|---|
| `redshift-opensearch-quicksight` | 11 | 11 | 3 | 2 (개념 1/문항 1) | — | — | — | — |
| `cloudwatch-xray` | 11 | 11 | 3 | 5 (개념 2/문항 3) | — | — | — | — |
...
`redshift-opensearch-quicksight` — 개념 11개. **①이 걸린 것은 굵게 표시했다.**
...
`cloudwatch-xray` — 개념 11개. **①이 걸린 것은 굵게 표시했다.**
...
`redshift-opensearch-quicksight` — 11개: `q260` `q261` `q262` `q263` `q264` `q265` `q266` `q267` `q268` `q269` `q270`

`cloudwatch-xray` — 11개: `q126` `q223` `q648` `q649` `q650` `q651` `q652` `q653` `q654` `q655` `q656`
...
node scripts/content-audit.mjs redshift-opensearch-quicksight# ①②④ 0건
node scripts/content-audit.mjs cloudwatch-xray# ①②④ 0건
```
