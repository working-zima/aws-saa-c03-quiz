# Step 11: elasticache-purpose-built-db
...
|---|---|---|---|---|---|---|---|---|
| `elasticache-purpose-built-db` | 14 | 16 | 3 | 11 (개념 3/문항 8) | — | — | — | — |
...
`elasticache-purpose-built-db` — 개념 14개. **①이 걸린 것은 굵게 표시했다.**
...
`elasticache-purpose-built-db` — 16개: `q072` `q073` `q185` `q187` `q423` `q424` `q425` `q426` `q427` `q428` `q429` `q430` `q431` `q432` `q433` `q434`
...
node scripts/content-audit.mjs elasticache-purpose-built-db# ①②④ 0건
```
