# Step 9: dynamodb-and-elasticache-purpose-built-db
...
|---|---|---|
| `dynamodb` | 18 | 20 |
| `elasticache-purpose-built-db` | 14 | 16 |
...
`dynamodb` — `q069` `q070` `q071` `q186` `q407` `q408` `q409` `q410` `q411` `q412` `q413` `q414` `q415` `q416` `q417` `q418` `q419` `q420` `q421` `q422`

`elasticache-purpose-built-db` — `q072` `q073` `q185` `q187` `q423` `q424` `q425` `q426` `q427` `q428` `q429` `q430` `q431` `q432` `q433` `q434`
...
const T=['dynamodb','elasticache-purpose-built-db'];
