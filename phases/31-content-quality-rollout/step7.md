# Step 7: storage-gateway-migration
...
|---|---|---|---|---|---|---|---|---|
| `storage-gateway-migration` | 7 | 13 | 1 | 5 (개념 2/문항 3) | — | — | — | — |
...
`storage-gateway-migration` — 개념 7개. **①이 걸린 것은 굵게 표시했다.**
...
`storage-gateway-migration` — 13개: `q052` `q053` `q054` `q055` `q056` `q057` `q368` `q369` `q370` `q371` `q372` `q373` `q374`
...
node scripts/content-audit.mjs storage-gateway-migration# ①②④ 0건
```
