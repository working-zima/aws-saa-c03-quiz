...
|---|---|---|---|---|---|---|---|---|
| `identity-federation` | 11 | 13 | 2 | 0 (개념 0/문항 0) | — | — | — | — |
...
`identity-federation` — 개념 11개. **①이 걸린 것은 굵게 표시했다.**
...
`identity-federation` — 13개: `q158` `q159` `q160` `q161` `q240` `q241` `q702` `q703` `q704` `q705` `q706` `q707` `q708`
...
node scripts/content-audit.mjs identity-federation# ①②④ 0건
```
