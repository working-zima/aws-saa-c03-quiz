...
|---|---|---|---|---|---|---|---|---|
| `ebs-instance-store` | 15 | 16 | 4 | 2 (개념 1/문항 1) | — | — | — | — |
...
`ebs-instance-store` — 개념 15개. **①이 걸린 것은 굵게 표시했다.**
...
`ebs-instance-store` — 16개: `q040` `q041` `q044` `q175` `q176` `q284` `q285` `q286` `q287` `q288` `q289` `q290` `q291` `q292` `q293` `q294`
...
node scripts/content-audit.mjs ebs-instance-store# ①②④ 0건
```
