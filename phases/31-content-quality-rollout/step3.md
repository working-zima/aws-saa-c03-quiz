...
|---|---|---|---|---|---|---|---|---|
| `s3-access-control` | 13 | 13 | 6 | 1 (개념 1/문항 0) | — | — | — | — |
...
`s3-access-control` — 개념 13개. **①이 걸린 것은 굵게 표시했다.**
...
`s3-access-control` — 13개: `q247` `q248` `q249` `q250` `q251` `q252` `q253` `q254` `q255` `q256` `q257` `q258` `q259`
...
node scripts/content-audit.mjs s3-access-control# ①②④ 0건
```
