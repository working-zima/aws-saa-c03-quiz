# Step 3: s3-encryption-batch-and-s3-access-control
...
| 주제 | 개념 | 문항 |
|---|---|---|
| `s3-encryption-batch` | 13 | 16 |
| `s3-access-control` | 13 | 13 |
...
`s3-encryption-batch` — `q034` `q035` `q036` `q037` `q038` `q039` `q173` `q174` `q276` `q277` `q278` `q279` `q280` `q281` `q282` `q283`

`s3-access-control` — `q247` `q248` `q249` `q250` `q251` `q252` `q253` `q254` `q255` `q256` `q257` `q258` `q259`
...
const T=['s3-encryption-batch','s3-access-control'];
