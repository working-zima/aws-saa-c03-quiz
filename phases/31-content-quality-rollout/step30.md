# Step 30: guardduty-macie-inspector
...
|---|---|---|---|---|---|---|---|---|
| `guardduty-macie-inspector` | 11 | 12 | 3 | 2 (개념 1/문항 1) | — | — | — | — |
...
`guardduty-macie-inspector` — 개념 11개. **①이 걸린 것은 굵게 표시했다.**
...
`guardduty-macie-inspector` — 12개: `q150` `q151` `q235` `q236` `q677` `q678` `q679` `q680` `q681` `q682` `q683` `q684`
...
node scripts/content-audit.mjs guardduty-macie-inspector# ①②④ 0건
```
