...
|---|---|---|---|---|---|---|---|---|
| `iam-permissions` | 18 | 23 | 9 | 3 (개념 1/문항 2) | — | — | — | — |
...
`iam-permissions` — 개념 18개. **①이 걸린 것은 굵게 표시했다.**
...
`iam-permissions` — 23개: `q155` `q156` `q157` `q237` `q238` `q239` `q685` `q686` `q687` `q688` `q689` `q690` `q691` `q692` `q693` `q694` `q695` `q696` `q697` `q698` `q699` `q700` `q701`
...
node scripts/content-audit.mjs iam-permissions# ①②④ 0건
```
