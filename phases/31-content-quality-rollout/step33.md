# Step 33: organizations-cloudtrail-config
...
|---|---|---|---|---|---|---|---|---|
| `organizations-cloudtrail-config` | 16 | 18 | 2 | 4 (개념 2/문항 2) | — | — | — | — |
...
`organizations-cloudtrail-config` — 개념 16개. **①이 걸린 것은 굵게 표시했다.**
...
`organizations-cloudtrail-config` — 18개: `q162` `q163` `q242` `q709` `q710` `q711` `q712` `q713` `q714` `q715` `q716` `q717` `q718` `q719` `q720` `q721` `q722` `q723`
...
node scripts/content-audit.mjs organizations-cloudtrail-config# ①②④ 0건
```
