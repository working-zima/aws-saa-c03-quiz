# Step 14: cloudfront-global-accelerator
...
|---|---|---|---|---|---|---|---|---|
| `cloudfront-global-accelerator` | 24 | 27 | 8 | 4 (개념 2/문항 2) | — | — | — | — |
...
`cloudfront-global-accelerator` — 개념 24개. **①이 걸린 것은 굵게 표시했다.**
...
`cloudfront-global-accelerator` — 27개: `q082` `q192` `q193` `q194` `q198` `q467` `q468` `q469` `q470` `q471` `q472` `q473` `q474` `q475` `q476` `q477` `q478` `q479` `q480` `q481` `q482` `q483` `q484` `q485` `q486` `q487` `q488`
...
node scripts/content-audit.mjs cloudfront-global-accelerator# ①②④ 0건
```
