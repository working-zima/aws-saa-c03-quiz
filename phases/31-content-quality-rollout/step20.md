# Step 20: backup-disaster-recovery
...
|---|---|---|---|---|---|---|---|---|
| `backup-disaster-recovery` | 11 | 11 | 4 | 9 (개념 4/문항 5) | — | — | — | — |
...
`backup-disaster-recovery` — 개념 11개. **①이 걸린 것은 굵게 표시했다.**
...
`backup-disaster-recovery` — 11개: `q098` `q208` `q577` `q578` `q579` `q580` `q581` `q582` `q583` `q584` `q585`
...
node scripts/content-audit.mjs backup-disaster-recovery# ①②④ 0건
```
