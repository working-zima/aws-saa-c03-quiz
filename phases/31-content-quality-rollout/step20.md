# Step 20: kinesis-streaming-and-redshift-opensearch-quicksight
...
| 주제 | 개념 | 문항 |
|---|---|---|
| `kinesis-streaming` | 16 | 17 |
| `redshift-opensearch-quicksight` | 11 | 11 |
...
`kinesis-streaming` — `q128` `q202` `q633` `q634` `q635` `q636` `q637` `q638` `q639` `q640` `q641` `q642` `q643` `q644` `q645` `q646` `q647`

`redshift-opensearch-quicksight` — `q260` `q261` `q262` `q263` `q264` `q265` `q266` `q267` `q268` `q269` `q270`
...
const T=['kinesis-streaming','redshift-opensearch-quicksight'];
