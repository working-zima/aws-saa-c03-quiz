...
|---|---|---|---|---|---|---|---|---|
| `emr-glue-athena` | 20 | 21 | 4 | 10 (개념 3/문항 7) | — | — | — | — |
...
`emr-glue-athena` — 개념 20개. **①이 걸린 것은 굵게 표시했다.**
...
`emr-glue-athena` — 21개: `q123` `q124` `q125` `q127` `q222` `q617` `q618` `q619` `q620` `q621` `q622` `q623` `q624` `q625` `q626` `q627` `q628` `q629` `q630` `q631` `q632`
...
node scripts/content-audit.mjs emr-glue-athena# ①②④ 0건
```
