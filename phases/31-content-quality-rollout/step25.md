# Step 25: governance-iac-and-systems-manager-and-ai-ml-services
...
`governance-iac` — `q295` `q296` `q297` `q298` `q299` `q300` `q301`

`systems-manager` — `q302` `q303` `q304` `q305` `q306` `q307` `q308` `q309`

`ai-ml-services` — `q310` `q311` `q312` `q313` `q314` `q315` `q316`
...
const T=['governance-iac','systems-manager','ai-ml-services'];
