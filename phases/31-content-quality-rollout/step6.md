...
|---|---|---|---|---|---|---|---|---|
| `data-transfer-services` | 19 | 20 | 8 | 12 (개념 4/문항 8) | — | — | — | — |
...
`data-transfer-services` — 개념 19개. **①이 걸린 것은 굵게 표시했다.**
...
`data-transfer-services` — 20개: `q049` `q050` `q051` `q351` `q352` `q353` `q354` `q355` `q356` `q357` `q358` `q359` `q360` `q361` `q362` `q363` `q364` `q365` `q366` `q367`
...
node scripts/content-audit.mjs data-transfer-services# ①②④ 0건
```
