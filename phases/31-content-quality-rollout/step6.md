# Step 6: data-transfer-services-and-storage-gateway-migration
...
| 주제 | 개념 | 문항 |
|---|---|---|
| `data-transfer-services` | 19 | 20 |
| `storage-gateway-migration` | 7 | 13 |
...
`data-transfer-services` — `q049` `q050` `q051` `q351` `q352` `q353` `q354` `q355` `q356` `q357` `q358` `q359` `q360` `q361` `q362` `q363` `q364` `q365` `q366` `q367`

`storage-gateway-migration` — `q052` `q053` `q054` `q055` `q056` `q057` `q368` `q369` `q370` `q371` `q372` `q373` `q374`
...
const T=['data-transfer-services','storage-gateway-migration'];
