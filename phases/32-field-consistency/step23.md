# Step 23: governance-iac-and-systems-manager-and-ai-ml
...
| 주제 | 개념 | 문항 | 범위 |
|---|---|---|---|
| `governance-iac` | 7 | 7 | 개념·문항 전부 |
| `systems-manager` | 7 | 8 | 개념·문항 전부 |
| `ai-ml-services` | 6 | 7 | 개념·문항 전부 |

### `governance-iac`

**개념 7개. 문장형 제목 0개.** 아래 목록에서 `▸`가 문장형이다.
...
`q295` `q296` `q297` `q298` `q299` `q300` `q301`
...
`q302` `q303` `q304` `q305` `q306` `q307` `q308` `q309`

### `ai-ml-services`

**개념 6개. 문장형 제목 0개.** 아래 목록에서 `▸`가 문장형이다.
...
- `sagemaker-autopilot` — 돌려

**`data.test.ts`가 글자로 고정한 제목·요약** — 고치려면 단언의 문구도 함께 맞춰야 한다.
**단언의 뜻은 바꾸지 마라.**

- `amazon-lex` — 단언이 잡고 있는 말: `대화형 인터페이스`

**문항 7개**

`q310` `q311` `q312` `q313` `q314` `q315` `q316`
...
node scripts/content-audit.mjs governance-iac systems-manager ai-ml-services
```
